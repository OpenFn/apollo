...
class LegacyPineconeDocsiteIndexer:
    """
    Legacy Pinecone-backed docsite indexer, preserved as the write-side rollback
    path for the Postgres migration. Selected via embed_docsite's `target`
    payload param. Deleted alongside pinecone_legacy_search.py in the cleanup PR.
